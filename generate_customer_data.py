...
if count > 0:
    ...
    conn.commit()
    print(f"Successfully generated and inserted 1000 customer records.")
...
# Example of adding real customers (comment this out if you just want to run the generator)
"""
real_customers = [
